         ...
         <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
            ...
            <div>
               ...
               {/* <div className=' flex flex-row gap-96  px-7 items-center  '> */}
				<Link to=""><FaLinkedin size={36} className='hover:text-gray-500 text-xl font-serif transition-all cursor-pointer'/></Link>
				<Link to=""><FaGithub size={36} className='hover:text-gray-500 text-xl font-serif transition-all cursor-pointer'/></Link>
				{/* <Link to=""><FaInstagram size={36} className='hover:text-gray-500 text-xl font-serif transition-all cursor-pointer'/></Link> */}
            <Link to="govindsajeev2001@gmail.com"><MdOutlineEmail size={36} className='hover:text-gray-500 text-xl font-serif transition-all cursor-pointer'/></Link>
				<Link to="https://wa.me/qr/6RULQZENNZBSC1"><FaWhatsapp size={36} className='hover:text-gray-500 text-xl font-serif transition-all cursor-pointer'/></Link>
